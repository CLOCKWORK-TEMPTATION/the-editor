...
- **scene-header-3**: اسم المكان التفصيلي
  - مثال: "منزل عبد العزيز - غرفة المكتب" أو "الشارع الرئيسي"
  - **مهم جداً**: إذا كان السطر يحتوي على شرطة (–) بعد اسم مكان، فالجزء بعد الشرطة هو **استكمال للمكان** وليس action
  - يبدأ عادة بكلمات: منزل، بيت، شارع، غرفة، مكتب، مطعم، مقهى، حديقة، مدرسة، جامعة، مستشفى
